...
public interface MySqlParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTableOptionEncrypted(MySqlParser.TableOptionEncryptedContext ctx);
	/**
	 * Exit a parse tree produced by the {@code tableOptionEncrypted}
	 * labeled alternative in {@link MySqlParser#tableOption}.
	 * @param ctx the parse tree
	 */
	void exitTableOptionEncrypted(MySqlParser.TableOptionEncryptedContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MySqlParser#encryptedLiteral}.
	 * @param ctx the parse tree
	 */
	void enterEncryptedLiteral(MySqlParser.EncryptedLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#encryptedLiteral}.
	 * @param ctx the parse tree
	 */
	void exitEncryptedLiteral(MySqlParser.EncryptedLiteralContext ctx);
	/**
